...
const corsOptions = {
    origin: [
        'http://127.0.0.1:5503',
        'http://localhost:5503',
        'http://16.170.215.57:3601',
        'http://16.170.215.57:8148', // HR Notification Portal
        'http://16.170.215.57:8147', // Employee Notification Portal
        'http://localhost:8147',
        'http://localhost:8148',
    ],
...
async function startServer() {
    try {
        ...
        app.listen(port, host, () => {
            console.log(`Server running on http://${host}:${port} (accessible at http://16.170.215.57${port})`);
        });
    } catch (error) {
